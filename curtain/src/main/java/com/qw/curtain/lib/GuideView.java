...
public class GuideView extends View {
    ...
    public OnClickTargetView onClickTargetView;

    public void setOnClickTargetView(OnClickTargetView onClickTargetView) {
        this.onClickTargetView = onClickTargetView;
    }

   public interface OnClickTargetView {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                for (HollowInfo mHollow : mHollows) {
                    int targetleft = mHollow.targetBound.left;
